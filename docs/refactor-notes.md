...
SOLUCIÓN -> Se renombran los paquetes para cumplir el estandar.
...
SOLUCIÓN -> Se elimina el constructor vacío y se añade la etiqueta @NoArgsConstructor de Lombock para crear un constructor vacio.
...
SOLUCIÓN -> Se reemplaza la lambda con la referencia del metodo: IllegalArgumentsException::new
...
SOLUCIÓN -> Se elimina el punto y coma sobrante
...
SOLUCIÓN -> Se eliminan los public de los test